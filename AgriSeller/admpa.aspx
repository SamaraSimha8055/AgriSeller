<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admpa.aspx.cs" Inherits="admpa" %>
    ...
    <div class="container" id="content" align="center"><h1>
      ...
      <div class="container" id="content" align="center">
          <table>
              ...
              <tr>
                  <td class="auto-style1"><asp:Button ID="Button1" runat="server" Text="FARMER APPROVAL" Height="41px" Width="240px" BackColor="#339933" OnClick="Button1_Click" />
                      <br />
                      <br />
                  </td>
          ...
          <div class="container" id="content" align="center">
                 ...
                 <tr>
                  ...
                  <asp:Button ID="Button3" runat="server" Text="USER APPROVAL" Height="41px" Width="241px" BackColor="#339933" OnClick="Button3_Click" /></td>
