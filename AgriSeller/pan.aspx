<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pan.aspx.cs" Inherits="pan" %>
  ...
  <br/>
    ...
    <div class="container" id="content" align="center"><h1>
      ...
      <div class="container" id="content" align="center">
          <asp:Button ID="Button1" runat="server" Text="ADMIN" BackColor="#339933" Height="37px" OnClick="Button1_Click" Width="192px" />
          <br />
          <br />
          </div>
          
         <div class="container" id="content" align="center">
          <asp:Button ID="Button2" runat="server" Text="FARMER" BackColor="#339933" Height="41px" OnClick="Button2_Click" Width="192px" />
             <br />
             <br />
          </div>
          <div class="container" id="content" align="center">
          <asp:Button ID="Button3" runat="server" Text="USER" BackColor="#339933" Height="41px" OnClick="Button3_Click" Width="188px" />
              <br />
          </div>
