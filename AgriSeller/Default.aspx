...
<head runat="server">
  ...
  <body style="background-image:url('im/1.jpg');background-repeat: no-repeat;height:100%">
      <form runat="server">
  <br/>
    ...
    <div class="container" id="content" align="center"><h1>
      ...
      <div class="container" id="content" align="center">
          ...
          <asp:Button ID="Button1" runat="server" Text="Enter" BackColor="#009933" Height="35px" OnClick="Button1_Click" Width="184px" />
          </div>
