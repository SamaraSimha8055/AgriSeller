<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ureg.aspx.cs" Inherits="ureg" %>
  ...
  <br/>
    ...
    <div class="container" id="content" align="center"><h1>
      ...
      <div class="container" id="content" align="center">
        <table>
              <tr>
                  <td><asp:Label ID="Label1" runat="server" Text="Farmer Name"></asp:Label></td>
            ...
            <asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>
              ...
              <tr>
                  ...
                  <td></td>
                  <td class="auto-style1"><asp:Button ID="Button2" runat="server" Text="Register" BackColor="#00CCFF" Height="37px"  Width="95px" OnClick="Button1_Click" />
                      <asp:Button ID="Button3" runat="server" Text="Back" Width="94px" BackColor="#FF6666" Height="38px" OnClick="Button2_Click"  />
                  </td>
