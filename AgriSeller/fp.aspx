  ...
  <br/>
    ...
    <div class="container" id="content" align="center"><h1>
      ...
      <div class="container" id="content" align="center">
        <table>
              <tr>
                  <td><asp:Label ID="Label1" runat="server" Text="Product Category"></asp:Label></td>
            ...
            <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
              ...
              <tr>
                  <td><asp:Label ID="Label2" runat="server" Text="Product Name"></asp:Label></td>
                  <td class="auto-style1">
            <asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>
             ...
             <tr>
                  <td><asp:Label ID="Label8" runat="server" Text="Product Price"></asp:Label></td>
                  <td class="auto-style1">
            <asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>
              ...
              <tr>
                  ...
                  <td></td>
                  <td class="auto-style1"><asp:Button ID="Button2" runat="server" Text="Add" BackColor="#00CCFF" Height="37px"  Width="95px" OnClick="Button1_Click" />
                  </td>
