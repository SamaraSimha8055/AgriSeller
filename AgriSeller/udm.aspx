<%@ Page Language="C#" AutoEventWireup="true" CodeFile="udm.aspx.cs" Inherits="udm" %>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <br />
                    <br />
                    <asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl="~/ureg.aspx">Registeration</asp:LinkButton>
                </td>
