...
public partial class freg : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            cmd.CommandText = " insert into far(fname,fpass,mob) values (@nam,@unam, @pass)";
            ...
            cmd.ExecuteNonQuery();
            Response.Write("<script>alert('Farmer is sucessfully registered ')</script>");
            con.Close();
        }
        catch (Exception ex)
        {
