...
<head runat="server">
    ...
    <div class="container" id="content" align="center"><h1>
      ...
      <div class="container" id="content" align="center">
          <table>
              ...
              <tr>
                  <td class="auto-style1"><asp:Button ID="Button1" runat="server" Text="Generate OTP" Height="41px" Width="240px" BackColor="#339933" OnClick="Button1_Click" />
                      <br />
                      <br />
                  </td>
 ...
 <tr>
                  ...
                  <asp:Label ID="Label1" runat="server" Text="Enter OTP"></asp:Label></td>
          ...
          <div class="container" id="content" align="center">
                 ...
                 <tr>
                  <td class="auto-style1">
                  <asp:Button ID="Button3" runat="server" Text="Login" Height="41px" Width="127px" BackColor="#339933" OnClick="Button3_Click" /></td>
